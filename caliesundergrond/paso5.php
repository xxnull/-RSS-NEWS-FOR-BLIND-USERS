    ...
    <div class="col-md-3">
    		...
    		<div class="menu2014">
				...
				$newname =	$_SESSION['newname'] ;
					...
					$uid = $_SESSION['uid'];
					$db = new conexion();
					$resultado = $db->query("UPDATE bandas SET rut ='".$newname."'  WHERE id='".$uid."' ");
        ...
        <div class="col-md-7 infozone">
        	...
        	<div class="texto">
			<h1>Fotocopia cedula representante legal</h1><br>
           ...
           <form role="form" action="paso6.php" enctype="multipart/form-data" method="post">
